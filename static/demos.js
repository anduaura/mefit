...
const DEMOS = {
  ...
  // Weighted (gym days — dumbbells + cable pulldown machine)
  "dumbbell bench press":             { id: "Dumbbell_Bench_Press",              yt: "dumbbell bench press proper form" },
  "wide-grip lat pulldown":           { id: "Wide-Grip_Lat_Pulldown",            yt: "lat pulldown proper form" },
  "dumbbell goblet squat":            { id: "Dumbbell_Squat",                    yt: "dumbbell goblet squat form" },
  "dumbbell squat":                   { id: "Dumbbell_Squat",                    yt: "dumbbell squat proper form" },
  "dumbbell romanian deadlift":       { id: "Stiff-Legged_Dumbbell_Deadlift",    yt: "dumbbell romanian deadlift form" },
  "dumbbell step-ups":                { id: "Dumbbell_Step_Ups",                 yt: "dumbbell step ups form" },
  "seated cable rows":                { id: "Seated_Cable_Rows",                 yt: "seated cable row proper form" },
  "dumbbell lunges":                  { id: "Dumbbell_Lunges",                   yt: "dumbbell lunges proper form" },
};
